...
test('@composeDirective', async () => {
    ...
    normalizedSDL.match(linksRegex).forEach((element) => {
        ...
        if (urlRegex.test(element)) {
            ...
            const linkUrlSpecVersionRegex = /https:\/\/myspecs.dev\/myCustomDirective\/v(.+)/;
    ...
    expect(normalizedSDL).toMatch(/schema.*(@composeDirective|@federation__composeDirective)\(name:.*"@custom"\)/);
...
//# sourceMappingURL=composeDirective.test.js.map