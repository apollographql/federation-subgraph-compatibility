...
async function fetchWithRetry(url, init, retries, maxTimeout) {
    let lastError;
...
async function healthcheckRouter() {
    ...
    try {
        const routerHealthcheck = await fetchWithRetry(ROUTER_HEALTH_URL, {}, 10, 1000);
