...
exports.healthcheck = exports.healthcheckRouter = exports.healtcheckSupergraph = exports.healthcheckAll = exports.routerRequest = exports.productsRequest = exports.graphqlRequest = exports.ROUTER_URL = void 0;
...
async function healthcheckAll(libraryName) {
...
async function healtcheckSupergraph(url) {
    const routerUp = await healthcheckRouter();
    return (routerUp &&
...
exports.healtcheckSupergraph = healtcheckSupergraph;
