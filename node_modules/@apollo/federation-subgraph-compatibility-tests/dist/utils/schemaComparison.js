...
const productsRaw = (0, fs_1.readFileSync)((0, path_1.resolve)(__dirname, '../../../..', 'implementations', '_template_library_', 'products.graphql'), 'utf-8');
...
function compareSchemas(schemaToCompare) {
    ...
    const actualQueryDefinition = findObjectTypeExtensionDefinition(schemaDefinition, 'Query') ??
