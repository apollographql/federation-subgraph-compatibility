...
const COMPOSITION_VERSION = process.env['APOLLO_ROVER_DEV_COMPOSITION_VERSION'] ?? '2.4.3';
const ROUTER_VERSION = process.env['APOLLO_ROVER_DEV_ROUTER_VERSION'] ?? '1.18.0';
