...
const COMPOSITION_VERSION = process.env['APOLLO_ROVER_DEV_COMPOSITION_VERSION'] ?? '2.5.1';
const ROUTER_VERSION = process.env['APOLLO_ROVER_DEV_ROUTER_VERSION'] ?? '1.29.1';
