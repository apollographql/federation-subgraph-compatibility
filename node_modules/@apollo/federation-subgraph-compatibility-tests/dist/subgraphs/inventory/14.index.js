...
const graphql_1 = __webpack_require__(6155);
const lodash_sortby_1 = __importDefault(__webpack_require__(254));
...
const graphql_1 = __webpack_require__(6155);
const usage_reporting_protobuf_1 = __webpack_require__(885);
...
exports.jy = exports.Nb = void 0;
var calculateReferencedFieldsByType_1 = __webpack_require__(9862);
Object.defineProperty(exports, "Nb", ({ enumerable: true, get: function () { return calculateReferencedFieldsByType_1.calculateReferencedFieldsByType; } }));
var signature_1 = __webpack_require__(1577);
Object.defineProperty(exports, "jy", ({ enumerable: true, get: function () { return signature_1.usageReportingSignature; } }));
//# sourceMappingURL=index.js.map
...
const utils_dropunuseddefinitions_1 = __webpack_require__(4489);
const utils_stripsensitiveliterals_1 = __webpack_require__(2264);
const utils_printwithreducedwhitespace_1 = __webpack_require__(1256);
const utils_removealiases_1 = __webpack_require__(9716);
const utils_sortast_1 = __webpack_require__(661);
...
// Packages
var retrier = __webpack_require__(5952);
...
module.exports = __webpack_require__(7750);
...
var RetryOperation = __webpack_require__(4459);
...
var $protobuf = __webpack_require__(1516);
...
// EXTERNAL MODULE: ./node_modules/@apollo/usage-reporting-protobuf/generated/protobuf.mjs
var protobuf = __webpack_require__(2025);
// EXTERNAL MODULE: ./node_modules/@apollo/utils.usagereporting/dist/index.js
var dist = __webpack_require__(1410);
// EXTERNAL MODULE: ./node_modules/async-retry/lib/index.js
var lib = __webpack_require__(3415);
...
var node_abort_controller = __webpack_require__(5220);
// EXTERNAL MODULE: ./node_modules/node-fetch/lib/index.js
var node_fetch_lib = __webpack_require__(467);
...
var traceTreeBuilder = __webpack_require__(5267);
// EXTERNAL MODULE: ./node_modules/@apollo/server/node_modules/lru-cache/index.js
var lru_cache = __webpack_require__(8956);
...
class OurReport {
    ...
    addTrace({ statsReportKey, trace, asTrace, referencedFieldsByType, maxTraceBytes = 10 * 1024 * 1024, nonFtv1ErrorPaths, }) {
        ...
        if (asTrace) {
            const encodedTrace = protobuf/* Trace.encode */.fM.encode(trace).finish();
    ...
    addTrace(trace, sizeEstimator, nonFtv1ErrorPaths = []) {
        ...
        if (!trace.fullQueryCacheHit && trace.cachePolicy?.maxAgeNs != null) {
            switch (trace.cachePolicy.scope) {
                case protobuf/* Trace.CachePolicy.Scope.PRIVATE */.fM.CachePolicy.Scope.PRIVATE:
                    this.queryLatencyStats.privateCacheTtlCount.incrementDuration(trace.cachePolicy.maxAgeNs);
                    break;
                case protobuf/* Trace.CachePolicy.Scope.PUBLIC */.fM.CachePolicy.Scope.PUBLIC:
...
function makeTraceDetails(variables, sendVariableValues, operationString) {
    const details = new protobuf/* Trace.Details */.fM.Details();
    ...
    return (0,internalPlugin/* internalPlugin */.U)({
        ...
        async serverWillStart({ logger: serverLogger, apollo, startedInBackground, schema, }) {
            ...
            const overriddenExecutableSchemaId = options.overrideReportedSchema
                ? (0,computeCoreSchemaHash/* computeCoreSchemaHash */.n)(options.overrideReportedSchema)
                : undefined;
            ...
            const sendReport = async (executableSchemaId) => {
                ...
                const protobufError = protobuf/* Report.verify */.yG.verify(report);
                if (protobufError) {
                    throw new Error(`Error verifying report: ${protobufError}`);
                }
                let message = protobuf/* Report.encode */.yG.encode(report).finish();
                report = null;
                if (options.debugPrintReports) {
                    const decodedReport = protobuf/* Report.decode */.yG.decode(message);
            ...
            requestDidStartHandler = ({ metrics, schema, request: { http, variables }, }) => {
                ...
                if (http) {
                    treeBuilder.trace.http = new protobuf/* Trace.HTTP */.fM.HTTP({
                        method: protobuf/* Trace.HTTP.Method */.fM.HTTP.Method[http.method] || protobuf/* Trace.HTTP.Method.UNKNOWN */.fM.HTTP.Method.UNKNOWN,
                        host: null,
                        path: null,
                    });
                ...
                async function operationFinished(requestContext) {
                    ...
                    if (policyIfCacheable) {
                        treeBuilder.trace.cachePolicy = new protobuf/* Trace.CachePolicy */.fM.CachePolicy({
                            scope: policyIfCacheable.scope === 'PRIVATE'
                                ? protobuf/* Trace.CachePolicy.Scope.PRIVATE */.fM.CachePolicy.Scope.PRIVATE
                                : policyIfCacheable.scope === 'PUBLIC'
                                    ? protobuf/* Trace.CachePolicy.Scope.PUBLIC */.fM.CachePolicy.Scope.PUBLIC
                                    : protobuf/* Trace.CachePolicy.Scope.UNKNOWN */.fM.CachePolicy.Scope.UNKNOWN,
                    ...
                    async function addTrace() {
                        ...
                        const protobufError = protobuf/* Trace.verify */.fM.verify(trace);
                        if (protobufError) {
                    ...
                    function getOperationDerivedData() {
                        ...
                        const generatedSignature = (options.calculateSignature || dist/* usageReportingSignature */.jy)(requestContext.document, requestContext.operationName || '');
                        const generatedOperationDerivedData = {
                            signature: generatedSignature,
                            referencedFieldsByType: (0,dist/* calculateReferencedFieldsByType */.Nb)({
    ...
    for (const [key, value] of headers) {
        ...
        switch (key) {
            ...
            case 'set-cookie':
                break;
            default:
                http.requestHeaders[key] = new protobuf/* Trace.HTTP.Values */.fM.HTTP.Values({
                    value: [value],
                });
        }
    }
