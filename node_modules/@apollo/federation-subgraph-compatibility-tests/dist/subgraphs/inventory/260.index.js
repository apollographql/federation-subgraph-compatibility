...
/* harmony import */ var _cachePolicy_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5667);
/* harmony import */ var _internalPlugin_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9916);
/* harmony import */ var lru_cache__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8956);
...
function ApolloServerPluginCacheControl(options = Object.create(null)) {
    ...
    return (0,_internalPlugin_js__WEBPACK_IMPORTED_MODULE_0__/* .internalPlugin */ .U)({
        ...
        async serverWillStart({ schema }) {
            typeAnnotationCache = new lru_cache__WEBPACK_IMPORTED_MODULE_1__({
                max: Object.values(schema.getTypeMap()).filter(graphql__WEBPACK_IMPORTED_MODULE_2__.isCompositeType)
                    .length,
            });
            fieldAnnotationCache = new lru_cache__WEBPACK_IMPORTED_MODULE_1__({
