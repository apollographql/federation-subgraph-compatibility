...
/* harmony import */ var _cachePolicy_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1841);
/* harmony import */ var _internalPlugin_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6175);
/* harmony import */ var lru_cache__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7799);
...
function ApolloServerPluginCacheControl(options = Object.create(null)) {
    ...
    return (0,_internalPlugin_js__WEBPACK_IMPORTED_MODULE_1__/* .internalPlugin */ .R)({
        __internal_plugin_id__: 'CacheControl',
        __is_disabled_plugin__: false,
        async serverWillStart({ schema }) {
            typeAnnotationCache = new lru_cache__WEBPACK_IMPORTED_MODULE_0__/* .LRUCache */ .q({
                max: Object.values(schema.getTypeMap()).filter(graphql__WEBPACK_IMPORTED_MODULE_2__.isCompositeType)
                    .length,
            });
            fieldAnnotationCache = new lru_cache__WEBPACK_IMPORTED_MODULE_0__/* .LRUCache */ .q({
                max: Object.values(schema.getTypeMap())
                    .filter(graphql__WEBPACK_IMPORTED_MODULE_2__.isObjectType)
                    .flatMap((t) => Object.values(t.getFields())).length +
                    Object.values(schema.getTypeMap())
                        .filter(graphql__WEBPACK_IMPORTED_MODULE_2__.isInterfaceType)
                        .flatMap((t) => Object.values(t.getFields())).length,
            });
            return undefined;
        },
            ...
            return {
                async executionDidStart() {
                    if (isRestricted(requestContext.overallCachePolicy)) {
                        const fakeFieldPolicy = (0,_cachePolicy_js__WEBPACK_IMPORTED_MODULE_3__/* .newCachePolicy */ .D)();
                        return {
                    ...
                    return {
                        willResolveField({ info }) {
                            const fieldPolicy = (0,_cachePolicy_js__WEBPACK_IMPORTED_MODULE_3__/* .newCachePolicy */ .D)();
                            ...
                            return () => {
                                if (fieldPolicy.maxAge === undefined &&
                                    (((0,graphql__WEBPACK_IMPORTED_MODULE_2__.isCompositeType)(targetType) && !inheritMaxAge) ||
                                        !info.path.prev)) {
                ...
                async willSendResponse(requestContext) {
                    ...
                    const cachePolicy = (0,_cachePolicy_js__WEBPACK_IMPORTED_MODULE_3__/* .newCachePolicy */ .D)();
