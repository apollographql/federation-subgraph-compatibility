...
const graphql_1 = __webpack_require__(7645);
...
const graphql_1 = __webpack_require__(7645);
const lodash_sortby_1 = __importDefault(__webpack_require__(6516));
...
const graphql_1 = __webpack_require__(7645);
const usage_reporting_protobuf_1 = __webpack_require__(2415);
...
exports.Ix = exports.Il = void 0;
var calculateReferencedFieldsByType_1 = __webpack_require__(4056);
Object.defineProperty(exports, "Il", ({ enumerable: true, get: function () { return calculateReferencedFieldsByType_1.calculateReferencedFieldsByType; } }));
var signature_1 = __webpack_require__(2649);
Object.defineProperty(exports, "Ix", ({ enumerable: true, get: function () { return signature_1.usageReportingSignature; } }));
//# sourceMappingURL=index.js.map
...
const utils_dropunuseddefinitions_1 = __webpack_require__(9677);
const utils_stripsensitiveliterals_1 = __webpack_require__(1996);
const utils_printwithreducedwhitespace_1 = __webpack_require__(2248);
const utils_removealiases_1 = __webpack_require__(176);
const utils_sortast_1 = __webpack_require__(3568);
...
// Packages
var retrier = __webpack_require__(5546);
...
var $protobuf = __webpack_require__(6247);
...
/* harmony export */   T: () => (/* binding */ packageVersion)
/* harmony export */ });
...
var protobuf = __webpack_require__(2042);
// EXTERNAL MODULE: ./node_modules/@apollo/utils.usagereporting/dist/index.js
var dist = __webpack_require__(8175);
// EXTERNAL MODULE: ./node_modules/async-retry/lib/index.js
var lib = __webpack_require__(5195);
// EXTERNAL MODULE: ./node_modules/graphql/index.js
var graphql = __webpack_require__(7645);
...
var internalPlugin = __webpack_require__(6175);
// EXTERNAL MODULE: ./node_modules/@apollo/server/dist/esm/plugin/traceTreeBuilder.js
var traceTreeBuilder = __webpack_require__(9373);
// EXTERNAL MODULE: ./node_modules/lru-cache/dist/esm/node/index.min.js
var index_min = __webpack_require__(7799);
...
function defaultSendOperationsAsTrace() {
    const cache = new index_min/* LRUCache */.q({
...
function createOperationDerivedDataCache({ logger, }) {
    let lastWarn;
    let lastDisposals = 0;
    return new index_min/* LRUCache */.q({
        sizeCalculation(obj) {
...
class OurReport {
    ...
    addTrace({ statsReportKey, trace, asTrace, referencedFieldsByType, maxTraceBytes = 10 * 1024 * 1024, nonFtv1ErrorPaths, }) {
        ...
        if (asTrace) {
            const encodedTrace = protobuf/* Trace */.Cn.encode(trace).finish();
    ...
    addTrace(trace, sizeEstimator, nonFtv1ErrorPaths = []) {
        ...
        if (!trace.fullQueryCacheHit && trace.cachePolicy?.maxAgeNs != null) {
            switch (trace.cachePolicy.scope) {
                case protobuf/* Trace */.Cn.CachePolicy.Scope.PRIVATE:
                    this.queryLatencyStats.privateCacheTtlCount.incrementDuration(trace.cachePolicy.maxAgeNs);
                    break;
                case protobuf/* Trace */.Cn.CachePolicy.Scope.PUBLIC:
...
function makeTraceDetails(variables, sendVariableValues, operationString) {
    const details = new protobuf/* Trace */.Cn.Details();
...
const reportHeaderDefaults = {
    ...
    agentVersion: `@apollo/server@${packageVersion/* packageVersion */.T}`,
...
function ApolloServerPluginUsageReporting(options = Object.create(null)) {
    ...
    return (0,internalPlugin/* internalPlugin */.R)({
        ...
        async serverWillStart({ logger: serverLogger, apollo, startedInBackground, schema, }) {
            ...
            if ((0,schemaIsSubgraph/* schemaIsSubgraph */.e)(schema)) {
            ...
            const getReportWhichMustBeUsedImmediately = (executableSchemaId) => {
                ...
                const report = new OurReport(new protobuf/* ReportHeader */.Y6({
            ...
            const overriddenExecutableSchemaId = options.overrideReportedSchema
                ? (0,computeCoreSchemaHash/* computeCoreSchemaHash */.u)(options.overrideReportedSchema)
                : undefined;
            ...
            function executableSchemaIdForSchema(schema) {
                ...
                const id = (0,computeCoreSchemaHash/* computeCoreSchemaHash */.u)((0,graphql.printSchema)(schema));
            ...
            const sendReport = async (executableSchemaId) => {
                ...
                report.endTime = (0,traceTreeBuilder/* dateToProtoTimestamp */.Q)(new Date());
                report.ensureCountsAreIntegers();
                const protobufError = protobuf/* Report */.pl.verify(report);
                if (protobufError) {
                    throw new Error(`Error verifying report: ${protobufError}`);
                }
                let message = protobuf/* Report */.pl.encode(report).finish();
                report = null;
                if (options.debugPrintReports) {
                    const decodedReport = protobuf/* Report */.pl.decode(message);
            ...
            requestDidStartHandler = ({ metrics, schema, request: { http, variables }, }) => {
                const treeBuilder = new traceTreeBuilder/* TraceTreeBuilder */.B({
                ...
                if (http) {
                    treeBuilder.trace.http = new protobuf/* Trace */.Cn.HTTP({
                        method: protobuf/* Trace */.Cn.HTTP.Method[http.method] || protobuf/* Trace */.Cn.HTTP.Method.UNKNOWN,
                    });
                ...
                async function operationFinished(requestContext) {
                    ...
                    if (policyIfCacheable) {
                        treeBuilder.trace.cachePolicy = new protobuf/* Trace */.Cn.CachePolicy({
                            scope: policyIfCacheable.scope === 'PRIVATE'
                                ? protobuf/* Trace */.Cn.CachePolicy.Scope.PRIVATE
                                : policyIfCacheable.scope === 'PUBLIC'
                                    ? protobuf/* Trace */.Cn.CachePolicy.Scope.PUBLIC
                                    : protobuf/* Trace */.Cn.CachePolicy.Scope.UNKNOWN,
                    ...
                    async function addTrace() {
                        ...
                        const protobufError = protobuf/* Trace */.Cn.verify(trace);
                        if (protobufError) {
                    ...
                    function getOperationDerivedData() {
                        ...
                        const generatedSignature = (options.calculateSignature || dist/* usageReportingSignature */.Ix)(requestContext.document, requestContext.operationName || '');
                        const generatedOperationDerivedData = {
                            signature: generatedSignature,
                            referencedFieldsByType: (0,dist/* calculateReferencedFieldsByType */.Il)({
    ...
    for (const [key, value] of headers) {
        ...
        switch (key) {
            ...
            case 'set-cookie':
                break;
            default:
                http.requestHeaders[key] = new protobuf/* Trace */.Cn.HTTP.Values({
                    value: [value],
                });
        }
    }
