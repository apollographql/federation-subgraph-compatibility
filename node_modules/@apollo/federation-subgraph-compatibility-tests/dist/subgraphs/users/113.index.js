...
// UNUSED EXPORTS: DEFAULT_APOLLO_SERVER_LANDING_PAGE_VERSION, DEFAULT_EMBEDDED_EXPLORER_VERSION, DEFAULT_EMBEDDED_SANDBOX_VERSION
...
var dist = __webpack_require__(4082);
...
function ApolloServerPluginLandingPageDefault(maybeVersion, config) {
    ...
    const apolloServerVersion = `@apollo/server@${packageVersion/* packageVersion */.T}`;
        ...
        async serverWillStart() {
            return {
                async renderLandingPage() {
                    ...
                    async function html() {
                        const nonce = (0,dist/* createHash */.n)('sha256')
