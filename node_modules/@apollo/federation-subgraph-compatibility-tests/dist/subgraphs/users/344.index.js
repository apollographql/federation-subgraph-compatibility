...
// Serialization
protobuf.Writer       = __webpack_require__(6430);
protobuf.BufferWriter = __webpack_require__(687);
protobuf.Reader       = __webpack_require__(5502);
protobuf.BufferReader = __webpack_require__(2927);

// Utility
protobuf.util         = __webpack_require__(8785);
protobuf.rpc          = __webpack_require__(2786);
protobuf.roots        = __webpack_require__(6868);
...
var util      = __webpack_require__(8785);
...
// extends Reader
var Reader = __webpack_require__(5502);
...
rpc.Service = __webpack_require__(9682);
...
util.asPromise = __webpack_require__(2222);

// converts to / from base64 encoded strings
util.base64 = __webpack_require__(5478);

// base class of rpc.Service
util.EventEmitter = __webpack_require__(2491);

// float handling accross browsers
util.float = __webpack_require__(8597);

// requires modules optionally and hides the call from bundlers
util.inquire = __webpack_require__(7206);

// converts to / from utf8 encoded strings
util.utf8 = __webpack_require__(958);

// provides a node-like buffer pool in the browser
util.pool = __webpack_require__(6239);

// utility to work with the low and high bits of a 64 bit value
util.LongBits = __webpack_require__(1434);
...
// extends Writer
var Writer = __webpack_require__(6430);
...
function inquire(moduleName) {
  try {
    if (false) {}
    var mod = __WEBPACK_EXTERNAL_createRequire(import.meta.url)(moduleName);
...
/* harmony export */   e: () => (/* binding */ schemaIsSubgraph)
/* harmony export */ });
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7645);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   B: () => (/* binding */ TraceTreeBuilder),
/* harmony export */   Q: () => (/* binding */ dateToProtoTimestamp)
/* harmony export */ });
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7645);
/* harmony import */ var _apollo_usage_reporting_protobuf__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2042);
/* harmony import */ var _utils_UnreachableCaseError_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2023);
...
class TraceTreeBuilder {
    rootNode = new _apollo_usage_reporting_protobuf__WEBPACK_IMPORTED_MODULE_0__/* .Trace */ .Cn.Node();
    trace = new _apollo_usage_reporting_protobuf__WEBPACK_IMPORTED_MODULE_0__/* .Trace */ .Cn({
        root: this.rootNode,
    ...
    constructor(options) {
        ...
        if (!sendErrors || 'masked' in sendErrors) {
            ...
            throw new _utils_UnreachableCaseError_js__WEBPACK_IMPORTED_MODULE_1__/* .UnreachableCaseError */ .N(sendErrors);
        }
    }
    startTiming() {
        if (this.startHrTime) {
    ...
    newNode(path) {
        const node = new _apollo_usage_reporting_protobuf__WEBPACK_IMPORTED_MODULE_0__/* .Trace */ .Cn.Node();
        const id = path.key;
        if (typeof id === 'number') {
            node.index = id;
        }
...
function errorToProtobufError(error) {
    return new _apollo_usage_reporting_protobuf__WEBPACK_IMPORTED_MODULE_0__/* .Trace */ .Cn.Error({
        message: error.message,
        location: (error.locations || []).map(({ line, column }) => new _apollo_usage_reporting_protobuf__WEBPACK_IMPORTED_MODULE_0__/* .Trace */ .Cn.Location({ line, column })),
...
function dateToProtoTimestamp(date) {
    ...
    return new _apollo_usage_reporting_protobuf__WEBPACK_IMPORTED_MODULE_0__/* .google */ .q7.protobuf.Timestamp({
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Cn: () => (/* binding */ Trace),
/* harmony export */   Y6: () => (/* binding */ ReportHeader),
/* harmony export */   pl: () => (/* binding */ Report),
/* harmony export */   q7: () => (/* binding */ google)
/* harmony export */ });
...
/* harmony import */ var _apollo_protobufjs_minimal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6247);
...
//# sourceMappingURL=344.index.js.map