...
/* harmony export */ });
/* harmony import */ var _apollo_utils_createhash__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4854);

function computeCoreSchemaHash(schema) {
    return (0,_apollo_utils_createhash__WEBPACK_IMPORTED_MODULE_0__/* .createHash */ .j)('sha256').update(schema).digest('hex');
}
